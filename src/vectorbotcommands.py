"""
File Name: vectorbotcommands.py
Author: Akli Amrous
...
class VectorBotGeneralCommands(commands.Cog):
    """
    This class represents a cog in terms of the discord api.
    ...
    def __init__(self, client):
        self.client = client
        self.SPEECH = "I'm applying for a new villain loan. I go by the name of Vector. It's a mathematical term, represented by an arrow with both direction and magnitude. Vector! That's me, because I commit crimes with both direction and magnitude. Oh yeah!"
