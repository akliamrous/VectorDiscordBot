...
Akli's Disclaimer
-----------------
The following code in this repository is not mine, it is a publically available
fork of the following repository https://github.com/gamagori/pizzapi and I am using
the fork of this repository by Jarvis Johnson https://github.com/Magicjarvis.
I am using this code as simply a way to communicate with the dominoes api and
I DO NOT IN ANYWAY CLAIM OWNERSHIP OF THIS CODE OR DOCUMENTATION FOUND BELOW.
Under the MIT license, I am able to use this code for private use.
